...
// solution: https://nickymeuleman.netlify.app/garden/aoc2023-day10#final-code
// Credits to nickymeuleman
...
pub fn parse(input: &str) -> (Vec<Vec<Tile>>, Coord) {
...
pub fn build_loop(start: Coord, map: &[Vec<Tile>]) -> HashSet<Coord> {
